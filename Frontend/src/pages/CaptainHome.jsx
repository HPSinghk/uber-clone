...
const CaptainHome = () => {
    ...
    const { captain,setLocation } = useContext(CaptainDataContext)
            ...
            if (navigator.geolocation) {
                navigator.geolocation.getCurrentPosition(
                    ...
                    },
                    {
                        ...
                        maximumAge: 0, // Cache duration for the location data
                    }
                );
            } else {
    ...
    return (
        <div className='h-screen'>
            <div className='fixed p-6 top-0 flex items-center justify-between w-screen'>
                ...
                <button onClick={CaptainLogout} className=' h-10 w-10 bg-white flex items-center justify-center rounded-full'>
